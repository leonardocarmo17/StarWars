...
Atualmente, a funcionalidade de salvar informações sobre o Log no banco de dados pelo site está indisponível em Guias Anônimas e em Modo Usuário (Sem Login). O host tem apresentado instabilidades, com limitações na execução do JavaScript
